...
insert into order_entity (id,num_order,date_order,customer_entity_id) values (1,1000,'2022-04-11',1);
insert into order_entity (id,num_order,date_order,customer_entity_id) values (2,1001,'2022-04-17',2);
insert into order_entity (id,num_order,date_order,customer_entity_id) values (3,1002,'2024-06-11',1);
