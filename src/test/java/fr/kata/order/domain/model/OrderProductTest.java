...
class OrderProductTest {
    ...
    void shouldNotAllowNullProduct() {
        assertThrows(IllegalArgumentException.class, () -> new OrderProduct(null, 2));
    }

    @Test
    void shouldNotAllowNegativeQuantity() {
        Product product = new Product(1, "Product 1", 10.0);
        assertThrows(IllegalArgumentException.class, () -> new OrderProduct(product, -2));
    }

    @Test
    void shouldNotAllowZeroQuantity() {
        Product product = new Product(1, "Product 1", 10.0);
        assertThrows(IllegalArgumentException.class, () -> new OrderProduct(product, 0));
    }
